...
export default function ServoStabilizerPortfolio() {
  const [portfolios, setPortfolios] = useState([
    {
      id: 1,
      title: 'Industrial Servo Stabilizer Installation',
      subTitle: 'Installation of 100 kVA servo stabilizer for manufacturing facility',
      images: [
    ...
    {
      id: 2,
      title: 'Commercial Servo Stabilizer Maintenance',
      subTitle: 'Complete maintenance and servicing of servo stabilizers for commercial buildings',
      images: [
    ...
    {
      id: 3,
      title: 'Servo Stabilizer for Medical Equipment',
      subTitle: 'High-precision servo stabilizers for sensitive medical diagnostic equipment',
      images: [
    ...
    {
      id: 4,
      title: 'Servo Stabilizer for Data Centers',
      subTitle: 'High-capacity servo stabilizers for critical data center infrastructure',
      images: [
    ...
    {
      id: 5,
      title: 'Servo Stabilizer Repair & Rewinding',
      subTitle: 'Complete repair and rewinding services for servo stabilizers',
      images: [
    ...
    {
      id: 6,
      title: 'Servo Stabilizer Modernization',
      subTitle: 'Upgrading old stabilizers with advanced digital control systems',
      images: [
    ...
    {
      id: 7,
      title: 'Residential Servo Stabilizer Solutions',
      subTitle: 'Advanced voltage stabilization for luxury homes and villas',
      images: [
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-xl border border-white/30 shadow-xl overflow-hidden flex flex-col justify-between">
          ...
          <div className="flex flex-wrap justify-between items-center p-5 border-b border-red-200/50 gap-3">
            <div className="flex items-center gap-3">
              ...
              <span className="font-semibold text-gray-800 text-base">Servo Stabilizers</span>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      placeholder="e.g. Industrial Servo Stabilizer Installation"
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      placeholder="e.g. Installation of 100 kVA servo stabilizer"
                      className="w-full px-4 py-2.5 rounded-lg border border-gray-200 text-sm text-gray-800 focus:outline-none focus:border-red-500 focus:ring-2 focus:ring-red-500/20 transition-all"
                      maxLength={200}
                    />
                    <div className="text-xs text-gray-400 mt-1 text-right">

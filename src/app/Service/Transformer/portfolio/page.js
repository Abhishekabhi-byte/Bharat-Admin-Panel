  ...
  const [portfolios, setPortfolios] = useState([
    {
      ...
      subTitle: 'Installation of 100 MVA power transformer for industrial substation',
      images: [
    ...
    {
      id: 2,
      title: 'Distribution Transformer Maintenance',
      subTitle: 'Complete maintenance and testing of distribution transformers for utility company',
      images: [
    ...
    {
      id: 3,
      title: 'Transformer Oil Filtration & Testing',
      subTitle: 'Advanced oil filtration and dielectric testing for transformer health monitoring',
      images: [
    ...
    {
      id: 4,
      title: 'Transformer Repair & Rewinding',
      subTitle: 'Complete repair and rewinding services for damaged power transformers',
      images: [
    ...
    {
      id: 5,
      title: 'Transformer Retrofit & Modernization',
      subTitle: 'Modernization of old transformers with smart monitoring and control systems',
      images: [
    ...
    {
      id: 6,
      title: 'Transformer Commissioning & Testing',
      subTitle: 'Comprehensive commissioning and testing of transformers for power plants',
      images: [
    ...
    {
      id: 7,
      title: 'Dry Type Transformer Installation',
      subTitle: 'Installation of dry type transformers for commercial and industrial applications',
      images: [
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-xl border border-white/30 shadow-xl overflow-hidden flex flex-col justify-between">
          ...
          <div className="flex flex-wrap justify-between items-center p-5 border-b border-red-200/50 gap-3">
            <div className="flex items-center gap-3">
              ...
              <span className="font-semibold text-gray-800 text-base">Transformer Services</span>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      placeholder="e.g. Installation of 100 MVA power transformer"
                      className="w-full px-4 py-2.5 rounded-lg border border-gray-200 text-sm text-gray-800 focus:outline-none focus:border-red-500 focus:ring-2 focus:ring-red-500/20 transition-all"
                      maxLength={200}
                    />
                    <div className="text-xs text-gray-400 mt-1 text-right">

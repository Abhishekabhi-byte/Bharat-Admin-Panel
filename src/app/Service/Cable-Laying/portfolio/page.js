...
export default function CableLayingPortfolio() {
  const [portfolios, setPortfolios] = useState([
    {
      id: 1,
      title: 'Underground Cable Laying Project',
      subTitle: 'Installation of 33 kV underground power cables for residential complex',
      images: [
    ...
    {
      id: 2,
      title: 'Industrial Cable Tray Installation',
      subTitle: 'Complete cable tray system installation for industrial manufacturing facility',
      images: [
    ...
    },
    {
      ...
      subTitle: 'High-speed fiber optic cable installation for telecommunication network',
      images: [
    ...
    {
      id: 4,
      title: 'HT Cable Laying for Industrial Zone',
      subTitle: 'High-tension cable laying for industrial zone power distribution',
      images: [
    ...
    {
      id: 5,
      title: 'Cable Jointing & Termination',
      subTitle: 'Professional cable jointing and termination services for power networks',
      images: [
    ...
    {
      id: 6,
      title: 'Cable Laying for Solar Farms',
      subTitle: 'Large-scale cable laying for solar power generation farms',
      images: [
    ...
    {
      id: 7,
      title: 'Submarine Cable Installation',
      subTitle: 'Specialized submarine cable laying for offshore power transmission',
      images: [
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-xl border border-white/30 shadow-xl overflow-hidden flex flex-col justify-between">
          ...
          <div className="flex flex-wrap justify-between items-center p-5 border-b border-red-200/50 gap-3">
            <div className="flex items-center gap-3">
              <Cable className="w-5 h-5 text-red-600" />
              <span className="font-semibold text-gray-800 text-base">Cable Laying</span>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      placeholder="e.g. Underground Cable Laying Project"
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      placeholder="e.g. Installation of 33 kV underground power cables"
                      className="w-full px-4 py-2.5 rounded-lg border border-gray-200 text-sm text-gray-800 focus:outline-none focus:border-red-500 focus:ring-2 focus:ring-red-500/20 transition-all"
                      maxLength={200}
                    />
                    <div className="text-xs text-gray-400 mt-1 text-right">
